...
/* Date Utilities
----------------------------------------------------------------------------------------------------------------------*/
exports.dayIDs = ['pzr', 'pts', 'salý', 'çarþ', 'perþ', 'cuma', 'cts'];
exports.unitsDesc = ['yýl', 'ay', 'hafta', 'gün', 'saat', 'dakika', 'saniye', 'milisaniye']; // descending
...
function computeDurationGreatestUnit(duration, durationInput) {
    ...
    if (unit === 'hafta' && typeof durationInput === 'object' && durationInput.days) {
        unit = 'gün';
    }
    return unit;
}
